<header class="d-flex flex-wrap align-items-center bg-primary
  ...
  if (isset($_SESSION['nombre'])) {
    ...
    <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
      <li ><a href="/Paginas/pag_1.php" class="nav-link px-2 link-white">inicio</a></a>
      <li ><a href="/Paginas/pag_2.php" class="nav-link px-2 link-white">inscripciones</a></a>
      <li ><a href="/Paginas/pag_3.php" class="nav-link link-white px-2 ">Docentes</a></a>
      <li class=""><a href="/Paginas/pag_4.php" class="nav-link link-white px-2 ">reportes</a></a>
      <li class=""><a href="/Paginas/pag_5.php" class="nav-link link-white px-2 ">Aulas</a></a>
    </ul>

    <div class="col-md-3 text-end">
      <a href="/Paginas/pag_6.php" class="btn btn-warning me-2">cambiar contraseña</a>
