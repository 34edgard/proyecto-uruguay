...
<div class="offcanvas-body p-3 row">
    ...
    <div class="card">
      <img src="../Img/images (1).jpeg" class="card-img-top" alt="niños el uruguay" style="height:250px;  ">
      <div class="card-body">
  ...
  <div class="col-md-10 themed-grid-col my-3">
    <div class="card">
      <img src="../Img/imagen1.jpg" class="card-img-top" alt="imagen1 lll" style="height:250px;  " >
      <div class="card-body">
  ...
  <div class="col-md-10 themed-grid-col my-3">
    <div class="card">
      <img src="../Img/escuela-republica.jpg" class="card-img-top" alt="escuela-republica" style="height:250px;  " >
      <div class="card-body">
  ...
  <div class="col-md-10 themed-grid-col my-3">
    <div class="card">
      <img src="../Img/images.jpeg" class="card-img-top" alt="escuela uruguay"  style="height:250px;  ">
      <div class="card-body">
