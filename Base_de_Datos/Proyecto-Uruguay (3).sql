...
--
-- Servidor: localhost
-- Tiempo de generación: 01-04-2025 a las 16:37:18
...
(14, 255, 'Edgard', 'Marcano', '2025-03-14', 'activo'),
(19, 390390, 'Edgard', 'Marcano', '2025-03-14', 'activo'),
(20, 868, 'Edgard', 'Marcano', '2025-03-18', 'activo');
...
--
-- Error leyendo la estructura de la tabla Proyecto-Uruguay.parentesco: #1932 - Table 'Proyecto-Uruguay.parentesco' doesn't exist in engine
-- Error leyendo datos de la tabla Proyecto-Uruguay.parentesco: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'FROM `Proyecto-Uruguay`.`parentesco`' at line 1
...
(7, NULL, NULL, 14, 'celular', NULL, NULL, '8555'),
...
(1, 309309, 'Jose loco', 'Alvarez Lopez ', 1, 'Usuario_1', 1, '12345678', 'activo'),
