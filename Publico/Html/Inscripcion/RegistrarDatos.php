  ...
  <fieldset class="container-fluid  img-thumbnail row">
    ...
    <ul class="nav nav-tabs" role="tablist">
      ...
      <li class="nav-item" role="presentation">
        <button type="button" class="nav-link active" data-bs-toggle="tab" data-bs-target="#representante" role="tab">datos de la representante</button>
      </li>
      <li class="nav-item" role="presentation">
      ...
      <li class="nav-item" role="presentation">
        <button type="button" class="nav-link " data-bs-toggle="tab" data-bs-target="#niño" role="tab" aria-selected="true">datos del niño/ña</button>
      </li>
...
<?php ?>
      ...
      <div class="tab-pane  table-responsive" id="niño" role="tabpanel">
        <div class=" d-grid">
