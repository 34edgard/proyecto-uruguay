...
>
  ...
  <fieldset class="thumbnail container d-flex flex-column justify-content-center flex-wrap align-items-center p-3">
    ...
    <label class="label-control  w-100   p-3">Usuario
      <input type="email" id="correo" name="correo" class="form-control " required placeholder="ingrese su usuario"></label>
    <label class="label-control  w-100   p-3">contraseña
      <input type="password" id="contraseña" name="contraseña" class="form-control  " required placeholder="Ingrese la Contraseña" ></label>
    <button type="submit" class="btn btn-primary w-50 m-auto" name="Inicio_secion" value="1bjj" id="enviar">enviar</button>
